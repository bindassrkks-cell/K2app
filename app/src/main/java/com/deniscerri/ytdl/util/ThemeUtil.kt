...
object ThemeUtil {
    ...
    fun updateTheme(activity: Activity) {
        ...
        val theme = sharedPreferences.getString("kupido2_theme", "System")!!
        when (theme) {
            "Light" -> {
        ...
        val iconMode = sharedPreferences.getString("kupido2_icon", "Default")!!
    ...
    fun getStyledAppName(context: Context): Spanned {
        ...
        return "<span  style='color:$hexColor';>Kupido</span>2"
